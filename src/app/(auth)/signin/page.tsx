...
export default function SigninPage() {
  ...
  const handleSSOSignIn = () => {
    // Placeholder for future SSO sign-in implementation
    router.push('/dashboard')
  }
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="w-full bg-white dark:bg-black border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900"
          >
            Sign in with SSO
          </Button>
        </div>
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="signin-email" className="text-sm font-medium text-gray-900 dark:text-white">
              Email
            </Label>
            <Input
              id="signin-email"
              ...
              className="w-full bg-gray-50 dark:bg-gray-900 border-gray-300 dark:border-gray-700"
            />
          </div>

          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label htmlFor="signin-password" className="text-sm font-medium text-gray-900 dark:text-white">
                Password
              </Label>
              <button
                type="button"
            ...
            <div className="relative">
              <Input
                ...
                className="w-full pr-10 bg-gray-50 dark:bg-gray-900 border-gray-300 dark:border-gray-700"
              />
              <button
                type="button"
